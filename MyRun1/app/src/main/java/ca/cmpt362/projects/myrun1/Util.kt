...
//Always have this permission feature to user before opening camera
object Util {
...
//    take image from that location and converts to Bitmap format, or converted to other formats
